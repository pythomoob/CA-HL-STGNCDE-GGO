...
def get_args():
    ...
    parser.add_argument('--ggo_iterations', default='', type=int, help='Number of iterations for GGO')
    parser.add_argument('--ggo_solutions', default='', type=int, help='Number of solutions (population size) for GGO')
